                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelStyle: TextStyle(
                          color:
                              recurringInvestmentEnabled ? black : Colors.grey,
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          ...
                          try {
                            ...
                            final durationYears =
                                validate.validateDurationYears(
                          ...
                          showDialog(
                            ...
                            builder: (context) {
                              ...
                              double totalValue = 0;
                              (yearlyValues, totalValue) =
                                  cicLogic.calculateTotalValue(
                                cic.initialInvestment,
                                cic.recurringInvestment,
                                cic.durationYears,
                              ...
                              return AlertDialog(
                                scrollable:
                                    true, // Allow scrolling for long outputs
                                shape: RoundedRectangleBorder(
                                  borderRadius: kBorderRadius,
                                  side: kBorderSide,
                                ),
